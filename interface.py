...
def new_customer():
    ...
    print(f'Welcome {customer.name} to Flicken Bank. {customer.cust_acc_num} is your account number')
...
while True:
    user_input = input('''Press 1 for creating a new customer:
...
Press 4 for exit\n''')
    ...
    if user_input == '1':
        ...
        print('There are currently', BankAccount.no_of_customer, 'customers in Flicken bank.')
    elif user_input == '4':
        print('Exited')
        break
    else:
